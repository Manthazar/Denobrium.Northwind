...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Northwind.Core.Models.CustomerCustomerType", b =>
                {
                    ...
                    b.ToTable("CustomerCustomerTypes", (string)null);
                });
            ...
            modelBuilder.Entity("Northwind.Core.Models.EmployeeTerritory", b =>
                {
                    ...
                    b.HasKey("EmployeeID", "TerritoryCode");

                    SqlServerKeyBuilderExtensions.IsClustered(b.HasKey("EmployeeID", "TerritoryCode"), false);
            ...
            modelBuilder.Entity("Northwind.Core.Models.Order", b =>
                {
                    ...
                    b.HasIndex(new[] { "CustomerCode" }, "CustomersOrders");
            ...
            modelBuilder.Entity("Northwind.Core.Models.CustomerCustomerType", b =>
                {
                    b.HasOne("Northwind.Core.Models.Customer", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("FK_CustomerCustomerType_Customers");

                    b.HasOne("Northwind.Core.Models.CustomerType", null)
                        .WithMany()
                        .HasForeignKey("CustomerTypeCode")
                        .IsRequired()
                        .HasConstraintName("FK_CustomerCustomerType_CustomerTypes");
                });
